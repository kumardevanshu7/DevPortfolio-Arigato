...
const portfolioData = {
  ...
  experiences: [
    {
      id: 1,
      company: "Arigato Devan",
      mark: "AD",
      role: "Founder & Web Developer",
      badge: "Platform Development & AI Content Creation",
      period: "Mar 2026 – Present",
      siteUrl: "https://arigatodevan.com/",
      isLive: true,
      description: "Designed, developed, and successfully launched arigatodevan.com using WordPress with Hostinger server configuration. Engineered AI prompt workflows and digital media assets for Instagram Reels/thumbnails, structured website layouts for galleries/blogs/FAQs, and managed Meta tags SEO, keywords finding, and Superprofile.",
      bullets: [
        "Designed, developed, and launched arigatodevan.com via WordPress and Hostinger, structuring responsive layouts for galleries, blogs, and SEO discovery",
        "Engineered photorealistic image generation prompts and digital media assets tailored for Instagram Reels, story thumbnails, video covers, and Superprofile"
      ]
    },
    {
      id: 2,
  ...
  socials: [
    ...
    },
    {
      name: "Instagram",
      handle: "@arigatodevan",
      url: "https://www.instagram.com/arigatodevan/",
      icon: "instagram",
      color: "#E1306C"
    },
    {
      name: "Superprofile",
      handle: "arigatodevan",
      url: "https://superprofile.bio/arigatodevan",
      icon: "superprofile",
      color: "#6366F1"
    },
    {
  ...
  tools: [
    ...
    { name: "Superprofile", icon: "superprofile" },
    { name: "Meta / FB", icon: "facebook" },
